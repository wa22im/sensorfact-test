...
export type DailyEnergyConsumption = z.infer<
  typeof DailyEnergyConsumptionSchema
>;
export type EnergyConsumptionHistory = z.infer<
  typeof EnergyConsumptionHistorySchema
>;
